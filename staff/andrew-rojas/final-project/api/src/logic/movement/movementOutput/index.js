...
function createMovementOutput(userId, productId, quantity, movement = "output") {
  ...
  return User.findById(userId)
    ...
    .then((user) => {
      ...
      return Product.findById(productId).then((product) => {
        ...
        return Movement.create({ product: product.id, quantity, movement })
          .catch((error) => {
            throw new SystemError(error.message);
          })
          .then((movement) => {
...
module.exports = createMovementOutput;
